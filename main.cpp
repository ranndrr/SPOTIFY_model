...
void userMenu(libraryList &L, Playlist &P) {
    ...
    while (true) {
        ...
        cout << "5. Mencari lagu berdasarkan data\n"; // CLEAR
        cout << "6. Putar Playlist\n"; // CLEAR
        cout << "7. Putar Lagu dari Library\n"; // CLEAR
        cout << "8. Kembali\n"; // CLEAR
        cout << "Pilih: ";
        cin >> pilih;
        ...
        if (pilih == 1) { // CLEAR
            ...
            adrLibrary hasil = searchSongByData(L, pilihan);

            if (hasil != nullptr) {
                cout << "\n=== LAGU DITEMUKAN ===\n";
                cout << "ID     : " << hasil->info.id << endl;
                cout << "Judul  : " << hasil->info.title << endl;
                cout << "Artis  : " << hasil->info.artist << endl;
                cout << "Album  : " << hasil->info.album << endl;
                cout << "Genre  : " << hasil->info.genre << endl;
                cout << "Tahun  : " << hasil->info.year << endl;
            } else {
                cout << "Lagu tidak ditemukan.\n";
            }
        ...
        } else if (pilih == 7) { // CLEAR
            string title;
            cout << "Judul Lagu: ";
            cin >> title;

            adrLibrary current = searchSong(L, title);
            if (current == nullptr) {
                cout << "Lagu tidak ditemukan di library.\n";
                continue;
            }

            cout << "\nMemutar: " << current->info.title << endl;
            ...
            while (true) {
                ...
                if (play == 1) {
                    if (current->next != nullptr) {
                        ...
                        cout << "Memutar: " << current->info.title << endl;
                    } else {
                    ...
                    if (current->prev != nullptr) {
                        ...
                        cout << "Sudah di lagu pertama library.\n";
                    }

                } else if (play == 3) {
                    adrLibrary similar = getSimilarSong(L, current);
                    if (similar != nullptr) {
                        current = similar;
                        cout << "Memutar (rekomendasi): "
